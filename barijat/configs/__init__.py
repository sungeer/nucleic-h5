...
from barijat.configs.dev_conf import DevSettings
from barijat.configs.prod_conf import ProdSettings
...
def get_settings():
    ...
    envs = ['SEC_KEY', 'JWT_SECRET_KEY', 'DB_USER', 'DB_PASSWD', 'REDIS_PASSWD', 'AI_API_KEY', 'AI_WORKSPACE_ID', 'AI_ROBOT_ID']
    envs_dict = {}
    for env in envs:
        key = env.lower()
